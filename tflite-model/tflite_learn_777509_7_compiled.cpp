 ...
 */
// Generated on: 07.09.2025 19:43:42
...
const TfArray<1, float> quant0_scale = { 1, { 0.034011710435152054, } };
const TfArray<1, int> quant0_zero = { 1, { -73 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data1[4] = { -410, 589, -13, -472, };
const TfArray<1, int> tensor_dimension1 = { 1, { 4 } };
const TfArray<1, float> quant1_scale = { 1, { 0.00044084616820327938, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[4*5] = { 
  5, 18, 127, -41, -39, 
  96, -43, -79, -70, -73, 
  -105, 99, -83, -92, 9, 
  -31, -35, -33, 45, 71, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 4,5 } };
const TfArray<1, float> quant2_scale = { 1, { 0.0099127171561121941, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[5] = { 980, 539, 398, -546, 59, };
const TfArray<1, int> tensor_dimension3 = { 1, { 5 } };
const TfArray<1, float> quant3_scale = { 1, { 0.0003182531800121069, } };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[5*10] = { 
  103, -65, -55, 85, -56, -20, 4, 69, 68, -32, 
  -59, 46, -99, 54, 85, -50, 76, -48, 70, 81, 
  -43, -8, -69, 99, 28, 55, 127, 40, -55, -11, 
  0, 70, 39, 20, 43, 54, -3, 16, -73, 48, 
  -34, 60, 84, -26, -43, 10, -8, 0, -41, 62, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 5,10 } };
const TfArray<1, float> quant4_scale = { 1, { 0.0078945104032754898, } };
const TfLiteAffineQuantization quant4 = { (TfLiteFloatArray*)&quant4_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data5[10] = { 1123, 283, -380, 1638, 457, 836, 1666, 946, 1114, -112, };
const TfArray<1, int> tensor_dimension5 = { 1, { 10 } };
const TfArray<1, float> quant5_scale = { 1, { 0.00020856072660535574, } };
const TfLiteAffineQuantization quant5 = { (TfLiteFloatArray*)&quant5_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data6[10*33] = { 
  -6, 51, -39, 16, -7, 7, 43, -3, 8, -85, 65, 34, 25, 93, 20, 44, 38, 22, -23, 112, 35, 3, -51, 70, -127, 9, -73, -40, -40, -27, -41, -96, 10, 
  -35, 2, 28, 7, 35, 40, -5, -29, -40, -14, 2, -79, 16, 35, -5, -50, 4, 19, 29, -40, -62, 29, 63, 59, 46, 58, 53, 52, 76, 4, -28, 66, 76, 
  65, -1, 15, -38, -30, 9, -28, -1, -22, 68, -11, -84, 38, -70, 34, -83, 36, -66, -21, -4, -60, -12, 41, -27, -13, 27, 52, 38, -4, 1, -1, 80, 46, 
  -50, 10, 49, -41, -20, -26, 30, -5, 42, 23, 0, 86, 49, -21, 45, 87, 61, 12, -13, 6, 50, 2, 81, -5, 65, 81, 88, 26, 25, 7, 51, -52, -108, 
  24, 30, -1, -72, -9, -47, -51, -11, -60, 6, -62, -64, 25, -54, -42, -2, -48, 7, 14, -12, -39, 35, 11, -90, -37, -81, -55, 28, -67, -65, 33, -19, 35, 
  4, 23, 67, 57, 14, -30, 13, -56, -11, -40, -66, -2, 18, -26, 32, -7, -42, 8, -7, -14, -68, -19, 10, 15, -28, 10, 61, 33, 35, 53, 52, 72, -41, 
  16, -4, -2, -31, -12, -71, -75, -22, 28, 18, -111, 17, 13, 15, 24, -6, -5, 42, 48, -97, 33, -62, 2, -63, 12, 9, 25, -1, -25, -20, 70, -5, -69, 
  53, -16, -51, 42, 22, 50, 44, 45, 50, 47, 6, -18, 23, -23, 23, 50, -22, 15, 55, 3, -22, -33, 66, 69, -13, -10, 43, 54, -32, -39, -46, -15, -18, 
  0, -92, 20, -29, 16, 25, -30, -67, -92, -2, 14, 26, -25, -18, 2, 5, 21, 10, 2, 42, 0, -67, -2, -40, -4, -80, -50, -59, -16, -77, -97, -67, 1, 
  -50, -6, 40, 39, -55, 4, 0, -43, -84, 20, 46, -54, -93, -17, -24, -37, -50, 23, -93, 11, -80, -77, -17, 26, -38, 11, -34, -11, -21, 27, 9, 6, 17, 
};
const TfArray<2, int> tensor_dimension6 = { 2, { 10,33 } };
const TfArray<1, float> quant6_scale = { 1, { 0.0061320271342992783, } };
...
const TfArray<1, float> quant7_scale = { 1, { 0.040313225239515305, } };
const TfArray<1, int> quant7_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant7 = { (TfLiteFloatArray*)&quant7_scale, (TfLiteIntArray*)&quant7_zero, 0 };
const TfArray<2, int> tensor_dimension8 = { 2, { 1,5 } };
const TfArray<1, float> quant8_scale = { 1, { 0.044472787529230118, } };
...
const TfArray<1, float> quant9_scale = { 1, { 0.10191215574741364, } };
...
{ kTfLiteMmapRo, kTfLiteInt8, (int32_t*)g0::tensor_data6, (TfLiteIntArray*)&g0::tensor_dimension6, 330, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&g0::quant6))}, },
{ kTfLiteArenaRw, kTfLiteInt8, (int32_t*)(tensor_arena + 48), (TfLiteIntArray*)&g0::tensor_dimension7, 10, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&g0::quant7))}, },
...
TfLiteStatus tflite_learn_777509_7_init( void*(*alloc_fnc)(size_t,size_t) ) {
...
TfLiteStatus tflite_learn_777509_7_input(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(in_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_777509_7_output(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(out_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_777509_7_invoke() {
...
TfLiteStatus tflite_learn_777509_7_reset( void (*free_fnc)(void* ptr) ) {
#ifdef EI_CLASSIFIER_ALLOCATION_HEAP
